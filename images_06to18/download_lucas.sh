...
#SBATCH --job-name=lucas_image_dl
#SBATCH --output=images_06to18/lucas_image_dl_%j.log

# ============================================================================
# This script downloads images, selected in the 'filter_urls.py' script.
...
# Set variables
cd images_06to18
URL_FILE="06to18_image_urls.txt"
OUTPUT_DIR="../crop_images_06to18"
