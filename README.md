...
First download the metadata lucas_cover_attr.csv from here: [lucas_cover_attr.csv](https://jeodpp.jrc.ec.europa.eu/ftp/jrc-opendata/LUCAS/LUCAS_COVER/tables/)
